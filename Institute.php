...
if (isset($_POST['submit'])) {
    ...
    $ins_location = mysqli_real_escape_string($conn, $_POST['ins_location']);

    if (empty($_POST['ins_Name'])) {
        $empty_name  = true;
    } elseif (empty($_POST['ins_location'])) {
        $empty_location  = true;
    } else {

        $sel_ins = "SELECT * FROM institute WHERE ins_Name='$ins_Name' ";
        $sqi_ins = mysqli_query($conn, $sel_ins);
        $ins_num_row = mysqli_fetch_row($sqi_ins);
        if ($ins_num_row > 0) {
            $error['dataAvleble'] = "Data is Alrady Exit";
        } else {
            $insert = "INSERT INTO institute(`ins_Name` ,`ins_location` ,`created_date`) VALUES ('$ins_Name' ,'$ins_location' , Now())";
                            ...
                            <div class="card   pb-5 ">
                                ...
                                <div class="container-fluid">
                                    <form action="" method="post">
                                        <div class="in py-3">
                                            <input type="text" name="ins_Name" id="ins_Name" class=" input w-100 py-2" placeholder="Institute Name">
                                            <?php if ($empty_name ) {
                                                echo '<p class="text-danger text-end m-0 p-0  font"> Please Fill Institute Name</p>';
                                            } ?>
                                        </div>

                                        <div class="in">
                                            <input type="text" name="ins_location" class=" input w-100 py-2" placeholder="Institute Location" id="ins_location">
                                            <?php if ($empty_location ) {
                                                echo '<p class="text-danger text-end m-0 p-0  font"> Please Fill Institute location</p>';
                                            } ?>
                                            <!-- <span id="InsLocation" class="text-danger font"></span> -->
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-9 py-3 ">
                                            ...
                                            <div class="btn-edit-delete text-start px-1">
                                                <button type="submit" id="delete" name="delete" class="export-btn delete">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $sql_fach['ins_Name'] ?></td>
                                                            <td><?php echo $sql_fach['ins_location'] ?></td>
                                                            <td><?php echo $_SESSION['name'] ?></td>
                                                            <td><?php echo $sql_fach['created_by'] ?></td>
                                                        </tr>
                                                    <?php
